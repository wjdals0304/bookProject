...
<div class="container">
    ...
    <%@include file="/layout/categoryMenu.jsp" %>
		...
		<div class="col-lg-10 col-lg-10 category">
			...
			<div class="border_bottom">
				...
				<div class="info">
					...
					평점 : <span class="starRating"><span style="width:${book.allGpa}%">${book.allGpa}</span></span>
						 	(<fmt:formatNumber value="${book.allGpa / 10}"  type="number"/>점)
		...
		<c:if test="${fn:length(bookList) != '0' && bookList ne null}">
		         ...
		         <c:forEach items="${commentList}" var="comment">
			     	<tr>
			         	<td>
			            	...
			            	<span class="starRating"><span style="width:${comment.gpa * 10}%"></span></span>
			            	(${comment.gpa}점)
			        	</td>
			            <td class="text-right">
			            	${comment.regDate}
